                            ...
                            <tr>
                                ...
                                <?php if ($host_id && $category_num) {?>
                                    <td class="textHeaderDark" align="right">
                                        <a href="#" onclick="return refreshServerInfo(<?php print ("$host_id,$blade,$category_num");?>);"><img width="16" src="<?php echo $config['url_path']; ?>plugins/xfusionserver/static/images/refresh.png"></a>
                                    </td>
