...
include_once("./plugins/xfusionserver/includes/oid_tables.php");
include_once("./plugins/xfusionserver/includes/key_labels.php");
include_once("./plugins/xfusionserver/includes/snmp.php");
...
function refresh_form() {
    ...
    <link href="<?php echo $config['url_path']; ?>plugins/xfusionserver/static/xfusionserver.css" type="text/css" rel="stylesheet">
                            ...
                            <tr>
                                ...
                                <?php if ($host_id) {?>
                                    <td class="textHeaderDark" align="right">
                                        <a href="#" onclick="return refreshServerInfo(<?php print $host_id;?>, <?php print $category_num;?>)"><img width="16" src="<?php echo $config['url_path']; ?>plugins/xfusionserver/static/images/refresh.png"></a>
                                    </td>
