 ...
 */
if ($cmd == "index") {
	$indeies = _cacti_snmp_walk($hostname, $snmp_community, $temperatrue_index_oid, $snmp_version, $snmp_auth_username, $snmp_auth_password, $snmp_auth_protocol, $snmp_priv_passphrase, $snmp_priv_protocol, $snmp_context, $snmp_port, $snmp_timeout, $ping_retries, 10, SNMP_POLLER);
	foreach ($indeies as $index) {
		$oid = $index["oid"];
		$index_val = $index["value"];

		$object_name = _cacti_snmp_get($hostname, $snmp_community, $temperatrue_obj_oid.".".$index_val, $snmp_version, $snmp_auth_username, $snmp_auth_password, $snmp_auth_protocol, $snmp_priv_passphrase, $snmp_priv_protocol, $snmp_context, $snmp_port, $snmp_timeout, $ping_retries, SNMP_POLLER);
 ...
 */
	...
	if ($arg == "temperature") {
		$temperature_val = _cacti_snmp_get($hostname, $snmp_community, $temperatrue_oid.".".$index_val, $snmp_version, $snmp_auth_username, $snmp_auth_password, $snmp_auth_protocol, $snmp_priv_passphrase, $snmp_priv_protocol, $snmp_context, $snmp_port, $snmp_timeout, $ping_retries, SNMP_POLLER);
