 ...
 * Purpose ......... Auto scan XFUSION server in given subnet
 ***************************************************************************/
...
function scan_iprange($batch_id, $start_ip, $end_ip) {
    ...
    exec_background($command_string, $debug_str. "\"" . $config["base_path"] . "/plugins/xfusionserver/includes/jobs.php\" --action=scan_server --batch_id=" .$batch_id);
...
function scan_server_form()
{
    ...
    html_start_box("<strong>Auto Scan XFUSION Server</strong>", "100%", "", "3", "center", "");
    ?>
